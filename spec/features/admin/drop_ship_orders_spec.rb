  ...
  context 'as Admin' do
    ...
    context 'edit page' do
      ...
      it 'deliver button should properly fire for resend' do
        ...
        page.should have_content(Spree.t('admin.drop_ship_orders.deliver.success', number: @order1.id))
      end
    end
  ...
  context 'as Supplier' do
    ...
    context 'edit page' do
      ...
      it 'should properly display and allow confirmation' do
        ...
        page.should have_content(Spree.t('admin.drop_ship_orders.confirm.success', number: @order2.id))
      end
